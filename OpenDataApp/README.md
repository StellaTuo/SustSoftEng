...
The program is simple: the user needs to just give a date as an input and the program displays the bar chart of that day showing average production in MW for each hour
